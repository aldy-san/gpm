    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url(); ?>">
                <img src="<?= base_url('assets/images/logo/logo.png'); ?>" alt="logo" style="height:40px; width:40px;">
                <span>Survei GPM</span>
            </a>
            <div class="d-flex align-items-center">
                <a href="<?= base_url('/constitution'); ?>"><b>Peraturan</b></a>
                <a href="<?= base_url(); ?>" class="btn btn-primary ms-4"><b>Login</b></a>
            </div>
        </div>
        ...
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="toggler">
                        <a href="#" class="sidebar-hide d-xl-none d-block ms-auto"><i class="bi bi-x bi-middle"></i></a>
                    </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?= $this->uri->segment(1) === 'manage-category' ? 'active' : ''; ?>">
                        ...
                        <li class="sidebar-item <?= uri_string() === 'survei/alumni' ? 'active' : ''; ?>">
                            <a href="<?= base_url('survei/alumni'); ?>" class='sidebar-link'>
                                <i class="bi bi-grid"></i>
                                <span>Survei Alumni </span>
                            </a>
                        </li>
                        <li class="sidebar-item <?= uri_string() === 'survei/mitra' ? 'active' : ''; ?>">
                            <a href="<?= base_url('survei/mitra'); ?>" class='sidebar-link'>
                                <i class="bi bi-grid"></i>
                                <span>Survei Mitra</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?= uri_string() === 'survei/pengguna' ? 'active' : ''; ?>">
                        ...
                        <li class="sidebar-item <?= $this->uri->segment(2) === 'dosen' ? 'active' :''?>">
                            <a href="<?= base_url('result/dosen'); ?>" class='sidebar-link'>
                                <i class="bi bi-grid"></i>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= base_url('mahasiswa/survei/dosen-terbaik'); ?>"
        ...
        <div id="main">
            ...
            <header class="mb-3 d-flex">
                ...
                <div class="d-flex align-items-center dropdown ms-auto">
                    ...
                    <button class="btn " type="button" id="profileButton" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <div class="avatar">
                    ...
                    <div class="dropdown-menu mt-2 shadow" aria-labelledby="profileButton">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="<?= base_url('change-password'); ?>"><i
                                class="bi bi-pencil-square me-2"></i>Ubah
                            Kata Sandi</a>
